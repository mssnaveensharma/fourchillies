...
<section id="right_side_banner_main_wrapper">
	...
	?>
	<section id="wedding_products_wrapper asas" class="product_list_wrapper wedding_products_wrapper_class">
	...
	<ul class="list-unstyled product_listing_ul product_lising_four_products">
	<?php $loop = new WP_Query(array('post_type' => 'product','product_cat' => $term->slug));?>		
	<?php if ( $loop->have_posts() ): while ( $loop->have_posts() ) : $loop->the_post(); ?>
	<?php Walleto_get_post();?>
	<?php  endwhile; ?>
	</ul>

...
ini_set('session.save_path', 'tmp');
	...
	*************************************/
	...
	add_image_size( 'main-image-post2', 300, 200, true );  
...
?>
		...
		<li>
                ...
                <a href="<?php the_permalink(); ?>"><?php echo Walleto_get_first_post_image(get_the_ID(),'attachment-150x150'); ?></a>
	...
	<tbody>
    	...
    	<td class="post" id="post-ID-<?php the_ID(); ?>">
    		...
    		<div class="image_holder">
            	...
            	<a class="my-title-post" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
...
function walleto_get_post_shop_function()
{
           ...
           <li>
	         <div class="product_block_top product_block_light_strip"></div>              
                <div class="product_block_middle">
                <a title="<?php the_title(); ?>" href="<?php the_permalink(); ?>"><?php echo walleto_get_first_post_image(get_the_ID(),'','','',$image_thing_tags,1); ?>
		   </a>
...

{
	...
	<tr><div class="my_order">
	    ...
	    <td><div class="my_order_id">#<?php echo $row->id ?></div></td>
...

{
	...
	?>
    	...
    	<tr class="my_order">
            ...
            <td class="my_order_id"><a href="<?php echo walleto_get_order_content_link($row->id)  ?>">#<?php echo $row->id ?></a></td>
...

{
	...
	<tr>
	<td><span class="red-txt">#<?php echo $row->id ?></span></td>

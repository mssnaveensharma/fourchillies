    ...
    <section class="login-submit-form" id="pop_wrapper"> 
		...
		<section class="login_form_inner">
		  ...
		  <form name="loginform" id="loginform" action="wp-login.php" method="post" class="sign_in_wrapper">
				...
				<input class="do_input form-control" required type="password" name="pwd" id="login_password" value=""/>
...
<section class="login_form_inner">
	...
	<input type="hidden" name="action" value="register" />	
							...
							<div class="form-group">							 
							<label for="register-phone"><?php _e('Phone number:',$current_theme_locale_name) ?></label>
							<input type="text" required class="do_input form-control" onkeypress="return numbersonly(event)" name="user_phone" id="user_phone" size="30" maxlength="100" value="<?php echo wp_specialchars($user_phone); ?>" />
							</div>
							...
							<br><br><div class="update sign_in_button  pull-left">
...
$(document).ready(function(){
	...
	$('#register_button').click(function(e){
		...
		$('#reg_pop_wrapper').show(500);
		$('#reg_remove_popup').click(function(){
		$('#reg_pop_wrapper').hide(500);
		});
	});	
});

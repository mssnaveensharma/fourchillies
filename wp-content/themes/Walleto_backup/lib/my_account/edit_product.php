...
?>
	...
	<div id="content" >
            ...
            <div class="my_box3">
            	...
            	<div class="box_title my_account_title"><?php printf(__("Edit Product - %s", "Walleto"), $post_au->post_title); ?></div>
...
{% } %}
                ...
                <ul class="post-new_edit_proj">
                    <li>
                        <h2><?php echo __('Your product title', 'Walleto'); ?>:</h2>
                        <p><input type="text" size="50" class="do_input" name="product_title" value="<?php echo  $post_au->post_title; ?>" /> </p>
                    </li>
               
               
               <li><h2><?php echo __('Category', 'Walleto'); ?>:</h2>
                    <p><?php	echo Walleto_get_categories("product_cat", (is_array($cat) ? $cat[0]->term_id : ""), __("Select Category","Walleto"), "do_input"); ?></p>
                </li>
        ...
        <input type="text" size="10" name="price" class="do_input" 
        	value="<?php echo  get_post_meta($pid, 'price', true) ; ?>" /> <?php if($Walleto_currency_position != "front") echo walleto_get_currency(); ?>
        ...
        <p><input type="text" size="10" name="quant" class="do_input" value="<?php echo get_post_meta($pid, 'quant', true) ; ?>" /> 
        ...
        <p><textarea rows="6" cols="50" class="do_input" id="product_description"  name="product_description"><?php echo  trim($post_au->post_content); ?></textarea>
        ...
        <p><textarea rows="3" cols="50" class="do_input" id="other_details"  name="other_details"><?php echo get_post_meta($pid, 'other_details', true); ?></textarea>
	   ...
	   ?>
        ...
        <p><input type="text" size="40" class="do_input"  name="product_tags" value="<?php echo $product_tags; ?>" /> 
        ...
        <input type="submit" name="product_submit_edit" value="<?php _e("Save Product", 'Walleto'); ?> >>" /></p>
        </li>

...
***************************************************************************/
	...
	function Walleto_filter_ttl($title){ global $post_au; return __("Delete Product",'Walleto')." - ".$post_au->post_title;}
...
?>
	...
	<div id="content" >
            ...
            <div class="my_box3">
            	...
            	<div class="box_title my_account_title"><?php printf(__("Delete Product - %s", "Walleto"), $post_au->post_title); ?></div>
				...
				if(isset($_POST['yes_confirm']))
				{
					...
					printf(__('Your item has been deleted. <a href="%s">Return to your account</a>.','Walleto'), $acc);
					echo '</div>';
					wp_delete_post($pid);
		...
		?>
				...
				_e('Are you sure you want to delete this product?','Walleto');

...
<div class="clear10"></div> <?php endif; ?>
    ...
    <ul class="post-new3">
        ...
        <li><h2><?php echo __('Shop Location', 'Walleto'); ?>:</h2>
			...
			, __("Select Location","Walleto"), "do_input"); ?></p>
        </li>
        
        <li>
        	<h2><?php echo __('Your shop title', 'Walleto'); ?>:</h2>
        	<p><input type="text" size="50" class="do_input" name="shop_title" value="<?php echo ($post_shop->post_title == "Auto Draft" ? __('Shop not setup yet.','Walleto') : $post_shop->post_title );  ?>" /></p>
        </li>
        
        
        <li>
        	<h2><?php echo __('Facebook Link', 'Walleto'); ?>:</h2>
        	<p><input type="text" size="40" class="do_input" name="facebook" value="<?php echo get_post_meta($post_shop->ID, 'facebook', true);  ?>" /></p>
        </li>
        
        <li>
        	<h2><?php echo __('Twitter Link', 'Walleto'); ?>:</h2>
        	<p><input type="text" size="40" class="do_input" name="twitter" value="<?php echo get_post_meta($post_shop->ID, 'twitter', true);  ?>" /></p>
        </li>
...
$('#thumbnails').append('<div class="div_div" id="image_ss'+bar[1]+'" ><img width="70" class="image_class" height="70" src="' + bar[0] + '" /><a href="javascript: void(0)" onclick="delete_this('+ bar[1] +')"><img border="0" src="<?php echo get_bloginfo('template_url'); ?>/images/delete_icon.png" border="0" /></a></div>');
	...
	?>
        ...
        <p><textarea rows="6" cols="45" class="do_input" id="shop_description"  name="shop_description"><?php echo $post_shop->post_content; ?></textarea></p>
        </li>

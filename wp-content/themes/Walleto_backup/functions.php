...
ini_set('session.save_path', 'tmp');
	...
	*************************************/
	...
	add_image_size( 'main-image-post', 170, 135, true );
	...
	add_image_size( 'slider-image', 150, 110, true );
...
jQuery('#thumbnails').append('<div class="div_div ss" id="image_ss'+bar[1]+'" ><img width="70" class="image_class" height="70" src="' + bar[0] + '" /><a href="javascript: void(0)" onclick="delete_this2('+ bar[1] +')"><img border="0" src="<?php echo get_bloginfo('template_url'); ?>/images/delete_icon.png" border="0" /></a></div>');
}
...
function walleto_display_unpaid_order_for_buyer($row)
{
	?>
    	<div class="my_order">
            ...
            <div class="my_order_price"><?php echo walleto_get_show_price($row->totalprice + $row->shipping) ?></div>
            <div class="my_order_left_to_pay"><?php echo walleto_get_show_price(walleto_left_to_pay_for_order($row->id)) ?></div>
    	...
    	<div class="my_order">
            ...
            <div class="my_order_buttons">
                ...
                <?php 
					...
					echo sprintf(__('Shipped on: %s.','Walleto'), $dt); ?>
        ...
        <div id="right-sidebar"> 
			<ul class="xoxo">
            	...
            	<li class="widget-container widget_text account_widget_thing"><h3 class="widget-title"><?php _e("My Account Menu",'Walleto'); ?></h3>
                    ...
                    <li><a <?php echo $shop_stp; ?> href="<?php echo get_permalink($shp_stp_id); ?>"><?php _e("My Shop Setup",'Walleto');?></a></li>
                    <li><a <?php echo $active_finances; ?> href="<?php echo get_permalink($finances); ?>"><?php _e("Finances",'Walleto');?></a></li>
                    <li><a <?php echo $active_messages; ?> href="<?php echo get_permalink($messages_page); ?>"><?php _e("Private Messages",'Walleto');?></a></li>
				...
				?>
                	<ul id="my-account-admin-menu">
                    <li><a href="<?php echo get_permalink(get_option('Walleto_post_new_page_id')); ?>"><?php _e("Sell New Product",'Walleto');?></a></li>
                ...
                <li class="widget-container widget_text account_widget_thing"><h3 class="widget-title"><?php _e("My Purchases",'Walleto'); ?></h3>
                    ...
                    <li><a <?php echo $active_not_shp; ?> href="<?php echo get_permalink($not_shipped); ?>"><?php echo sprintf(__("Not Shipped Orders %s",'Walleto'), $smopp);?></a></li>
                    <li><a <?php echo $active_shp; ?> href="<?php echo get_permalink($shipped); ?>"><?php _e("Shipped Orders",'Walleto');?></a></li>
                  	</ul>  

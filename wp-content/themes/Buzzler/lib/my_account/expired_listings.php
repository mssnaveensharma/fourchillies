...
function buzzler_my_account_exp_posted_listings_area_function()
{
	global $wpdb;
	global $current_user;
	get_currentuserinfo();
...
?>
	...
	<div id="content" class="content_my_account" >
    			...
    			<div class="my_box3">          
            	<div class="box_title menu-title-item"><h1><?php _e("Expired Listings",'Buzzler'); ?></h1></div>
                <div class="box_content"> 
					...
					query_posts( "meta_key=closed&meta_value=1&post_type=listing&order=DESC&orderby=id&author=".$uid."&posts_per_page=" . $lst_per_page );

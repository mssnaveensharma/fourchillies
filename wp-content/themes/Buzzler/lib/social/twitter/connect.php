...
$twitter_enabled 	= get_option('Buzzler_enable_twitter_login');
$consumer_key 		= get_option('Buzzler_twitter_consumer_key');
$consumer_secret 	= get_option('Buzzler_twitter_consumer_secret');
...
?>
<p>Buzzler plugin has not been configured for Twitter</p>

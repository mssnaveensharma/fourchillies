...
******************************************************************************/
	 ...
	 function Buzzler_render_login_page_uri(){
	?>
...
*****************************************************************************************/
	...
	function Buzzler_display_social_login()
	{
		
		$images_url = get_bloginfo('template_url') . "/lib/social/img/";
		$Buzzler_enable_facebook_login = get_option('Buzzler_enable_facebook_login');
		$Buzzler_enable_twitter_login 	= get_option('Buzzler_enable_twitter_login');
		
		if($Buzzler_enable_facebook_login == "yes" or $Buzzler_enable_twitter_login == "yes"):
		?>
        
        	<p>
					<label><?php _e('Connect with:','Buzzler'); ?></label>
        
        
        <?php
		
		 if( $Buzzler_enable_facebook_login == "yes" ) : ?>
			...
			<?php endif; ?>
			<?php if( $Buzzler_enable_twitter_login == "yes" ) : ?>
		...
		<input type="hidden" name="client_id" value="<?php echo get_option( 'Buzzler_facebook_app_id' ); ?>" />
...
*****************************************************************************************/
	...
	function Buzzler_social_connect_process_login( $is_ajax = false ){
	...
	$redirect_to = apply_filters('Buzzler_filter_social_redirect_url', $redirect_to, $social_connect_provider);
...
*****************************************************************************************/
	...
	add_action( 'login_form_social_connect', 	'Buzzler_social_connect_process_login');
	add_filter('login_form', 					'Buzzler_display_social_login');
	add_action( 'wp_footer', 					'Buzzler_render_login_page_uri' );
	add_filter('register_form', 					'Buzzler_display_social_login');

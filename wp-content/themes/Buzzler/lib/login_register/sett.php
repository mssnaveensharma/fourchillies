...
function Buzzler_new_user_notification($user_id, $plaintext_pass = '') {
	$user = new WP_User($user_id);
    
	$subject 	= get_option('Buzzler_new_user_email_subject');
	$message 	= get_option('Buzzler_new_user_email_message');	
	...
	Buzzler_send_email($user_email, $subject, $message);

}

function Buzzler_new_user_notification_admin($user_id) {
	$user = new WP_User($user_id);
    
	$subject 	= get_option('Buzzler_new_user_email_admin_subject');
	$message 	= get_option('Buzzler_new_user_email_admin_message');	

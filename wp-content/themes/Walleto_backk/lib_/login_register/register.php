	    ...
	    <span class="heading_text"><?php _e("Register",$current_theme_locale_name); ?> - <?php echo  get_bloginfo('name'); ?></span></div>
		  ...
		  <section class="loginpage_wrapper">                                         
						  ...
						  <input type="hidden" name="action" value="register" />	
							...
							<input type="text" required class="login_input" name="user_phone" onkeypress="return numbersonly(event)" id="user_phone" size="30" maxlength="100" value="<?php echo wp_specialchars($user_phone); ?>" />
							</div>
...
function Walleto_register_new_user_sitemile( $user_login, $user_email, $user_firstname, $user_lastname ) {
	...
	if ( $sanitized_user_login == '' ) {
		...
		$errors->add( 'username_exists', __( '<strong>ERROR</strong>: This username is already registered, please choose another oned.', $current_theme_locale_name ) );
	}

...
?>	
		...
		<div class="product_list_heading"> <span class="heading_text">Order Content</span></div>
		...
		<table class="shopping_cart table_white" width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr class="head">
                            ...
                            <td width="20%"><?php echo __('Product','Walleto'); ?></td>                            
                            <td width="25%"><?php echo __('Product Title','Walleto'); ?></td>
                            <td width="15%"><?php echo __('Seller','Walleto'); ?></td>
                            <td width="20%"><?php echo __('Item Price','Walleto'); ?></div></td>
                            <td width="15%"><?php echo __('Quantity','Walleto'); ?></td>
			    <td width="5%"><?php echo __('Shipped','Walleto'); ?></td>
			    <td width="5%"><?php echo __('Paid','Walleto'); ?></td>
                        </tr>
		</thead>   
					...
					<?php
						...
						foreach($r as $row)
						{
							...
							?>
                            	...
                            	<tr class="my_order">
                                    <td class="my_prod_pic"><?php echo walleto_get_first_post_image($row->pid,150,150,'thumbnail-image-post'); ?></td>
                                    <td class="my_prod_title"><a class="red-txt" href="<?php echo get_permalink($row->pid); ?>"><?php echo $post_au->post_title; ?></a></td>
                                    <td class="my_prod_owner"><?php echo ($owner->user_login); ?></td>
                                    <td class="my_prod_price"><?php echo walleto_get_show_price($row->price); ?></td>
                                    <td class="my_prod_quant"><?php echo $row->quant; ?></div>

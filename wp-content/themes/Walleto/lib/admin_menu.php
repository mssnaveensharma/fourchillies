    ...
    <div id="tabs1" style="display: block; ">
    	 ...
    	 <table class="widefat post fixed">
                ...
                <tr>
                    ...
                    <th colspan=2 style="text-align:left; font-size:16px"><strong><?php echo walleto_get_show_price($row->price) ?></strong></th>
...
$results_pid = $wpdb->get_results( 'SELECT pid FROM wp_walleto_order_contents WHERE orderid = '.$post->id );
//print_r($results2[0]->pid);
foreach($results_pid as $kes){
$results_auth = $wpdb->get_results( 'SELECT post_author FROM wp_posts WHERE ID = '.$kes->pid );
$results_auth_name = $wpdb->get_results( 'SELECT user_login FROM wp_users WHERE ID = '.$results_auth[0]->post_author );
//echo $results_auth_name[0]->user_login;
} 
			...
			<th><?php echo $results_auth_name[0]->user_login; ?></th>		

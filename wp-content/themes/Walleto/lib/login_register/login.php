...
function Walleto_sitemile_filter_ttl($title){ global $real_ttl; return $real_ttl." - ".get_bloginfo('sitename');}



function Walleto_do_login_scr()

		{
		  ...
		  */
		  ...
		  $_SERVER['redirect_me_back'] = $_GET['redirect_to'];
	    ...
	    <span class="heading_text"><?php _e("Retrieve Password",$current_theme_locale_name); ?> - <?php echo  get_bloginfo('name'); ?></span></div>
				...
				<form name="lostpass" action="wp-login.php?action=retrievepassword" method="post" id="loginform">
					...
					<input type="hidden" name="action" value="retrievepassword" required/>
					...
					<div class="form-group"><label><?php _e('Username or Email:',$current_theme_locale_name) ?></label></div>

                    <input type="text" class="login_input" required name="user_login" id="user_login" value="" size="30" tabindex="1" />
			...
			<input style="padding: 8px;" type="submit" name="submit" id="submit" value="<?php _e('Retrieve Password',$current_theme_locale_name); ?>"  class="submit_bottom" tabindex="3" />
					...
					<li><a class="green_btn" href="<?php bloginfo('home'); ?>/" title="<?php _e('Are you lost?',$current_theme_locale_name) ?>">&laquo; <?php _e('Home',$current_theme_locale_name) ?></a></li>
	    ...
	    <section id="right_side_banner_main_wrapper">
            ...
            <div class="product_list_heading"><br/>
	    <span class="heading_text"><?php _e("Retrieve Error",$current_theme_locale_name); ?> - <?php echo  get_bloginfo('name'); ?></span></div>
			  ...
			  echo "          </div>\n";
				...
				echo '</div></section></section></section>';
	    ...
	    <section id="right_side_banner_main_wrapper">
			...
			<?php
...

			  {
				...
				echo '</div></td></tr></table></section></section></section>';
			...
			echo '</div></div></div></section></section></section>';
			...
			default:
			  ...
			  //Any differences will be noted with end of line comments. 
				 ...
				 */
				 ...
				 if(empty($redirect_to)) $redirect_to = get_permalink(get_option('Walleto_my_account_page_id'));
	    ...
	    <section id="right_side_banner_main_wrapper">
            ...
            <div class="product_list_heading"><br/>
	    <span class="heading_text"><?php _e("Login",$current_theme_locale_name); ?> - <?php echo  get_bloginfo('name'); ?></span></div>
		  ...
		  <section class="loginpage_wrapper">
				...
				<input class="login_input" required type="text" name="log" id="log" value="<?php echo wp_specialchars(stripslashes($user_login), 1); ?>" size="30"  />
				...
				<input class="login_input" required type="password" name="pwd" id="login_password" value="" size="30"  />
				...
				<input class="login_input" name="rememberme" type="checkbox" id="rememberme" value="forever" tabindex="3" /> 
                ...
                <ul id="logins">
						  ...
						  <?php if (get_settings('users_can_register')) : ?>
							...
							<!--li><a class="green_btn" href="<?php //bloginfo('wpurl'); ?>/wp-login.php?action=register"><?php //_e('Register',$current_theme_locale_name) ?></a></li-->
							<li><a class="green_btn" id="register_button22" href="#"><?php _e('Register',$current_theme_locale_name) ?></a></li>
	...
	$(document).ready(function(){		
		  $('#register_button22').click(function(e){ 

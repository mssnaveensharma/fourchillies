...
<script>(function() {
  ...
  _fbq.push(['addPixelId', '318101078384702']);
})();
window._fbq = window._fbq || [];
window._fbq.push(['track', 'PixelInitialized', {}]);
</script>
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?id=318101078384702&amp;ev=PixelInitialized" /></noscript>	
	...
	?>
	<a class="brand-logo" href="<?php echo get_site_url(); // echo Walleto_advanced_search_link(); ?>"><img id="logo" alt="<?php bloginfo('name'); ?><?php bloginfo('description'); ?>"
